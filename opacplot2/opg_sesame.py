...
class OpgSesame:
    ...
    def toEosDict(self, Znum=None, Anum=None, Xnum=None, qeos=False, log=None):
        # You can get the hedp module from here:
        # https://github.com/luli/hedp
        try:
            from hedp import eos
        except ImportError:
            print('You need the hedp module. You can get it here: '
                  'https://github.com/luli/hedp.')
        ...
        # ion_ and ele_ grids rather than ioncc_ and ele_.
        if qeos:
